 ...
 * group 分组名
 */
function aetherupload(name, file, group) {

    var newInstance = Object.create(AetherUpload);

    newInstance.wrapperDom = $(file).parents("#aetherupload-wrapper-"+name);
